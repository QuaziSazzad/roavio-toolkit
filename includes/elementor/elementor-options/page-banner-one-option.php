...
$this->add_control(
	...
	[
		...
		'placeholder' => esc_html__('Enter home text', 'roavio-toolkit'),
		'label_block' => true,
		'condition' => [
			'layout_one_show_breadcrumb' => 'yes'
		]
	]
);
...
// Current Page Text
$this->add_control(
	'layout_one_current_page_text',
	[
		'label' => esc_html__('Current Page Text', 'roavio-toolkit'),
		'type' => \Elementor\Controls_Manager::TEXT,
		'default' => esc_html__('About Us', 'roavio-toolkit'),
		'placeholder' => esc_html__('Enter current page text', 'roavio-toolkit'),
		'label_block' => true,
		'condition' => [
			'layout_one_show_breadcrumb' => 'yes'
		]
