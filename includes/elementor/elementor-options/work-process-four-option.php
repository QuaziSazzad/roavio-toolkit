...
$this->add_control(
	...
	[
		...
		'default' => esc_html__('Improve your writing with artificial intelligence Platform', 'roavio-toolkit'),
		'label_block' => true,
	]
);
...
$repeater->add_control(
	...
	[
		...
		'default' => esc_html__('1', 'roavio-toolkit'),
	]
);
...
$repeater->add_control(
	...
	[
		...
		'type' => \Elementor\Controls_Manager::TEXT,
		'default' => esc_html__('Sing Up Or Create your account Full Free', 'roavio-toolkit'),
		'label_block' => true,
	]
);
...
$repeater->add_control(
	...
	[
		'label' => esc_html__('Show Arrow', 'roavio-toolkit'),
...
$this->add_control(
	'layout_four_items',
	[
		'label' => esc_html__('Process Items', 'roavio-toolkit'),
		'type' => \Elementor\Controls_Manager::REPEATER,
		'fields' => $repeater->get_controls(),
		'default' => [
			[
				'layout_four_number' => '1',
				'layout_four_item_title' => esc_html__('Sing Up Or Create your account Full Free', 'roavio-toolkit'),
				'layout_four_with_arrow' => 'no',
			],
			[
				'layout_four_number' => '2',
				'layout_four_item_title' => esc_html__('Write what your want? or write something you want', 'roavio-toolkit'),
				'layout_four_with_arrow' => 'yes',
			],
			[
				'layout_four_number' => '3',
				'layout_four_item_title' => esc_html__('Get Output or results', 'roavio-toolkit'),
				'layout_four_with_arrow' => 'no',
			],
		],
...
$this->add_control(
	...
	[
		'label' => esc_html__('Show Image Area', 'roavio-toolkit'),
		'type' => \Elementor\Controls_Manager::SWITCHER,
		'label_on' => esc_html__('Yes', 'roavio-toolkit'),
		'label_off' => esc_html__('No', 'roavio-toolkit'),
		'return_value' => 'yes',
