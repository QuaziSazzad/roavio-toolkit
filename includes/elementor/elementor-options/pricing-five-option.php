...
$repeater->add_control(
	...
	[
		...
		'default' => [
			[
				'layout_five_feature_text' => esc_html__('Custom software development', 'roavio-toolkit'),
			],
			[
				'layout_five_feature_text' => esc_html__('Requirement analysis & planning', 'roavio-toolkit'),
			],
			[
				'layout_five_feature_text' => esc_html__('Support and maintenance', 'roavio-toolkit'),
			],
			[
				'layout_five_feature_text' => esc_html__('Integration third-party services', 'roavio-toolkit'),
			],
			[
				'layout_five_feature_text' => esc_html__('Data backups and advanced', 'roavio-toolkit'),
			],
			[
				'layout_five_feature_text' => esc_html__('Analytics and reporting features', 'roavio-toolkit'),
			],
		],
...
$this->add_control(
	...
	[
		...
		'default' => [
			[
				'layout_five_package_title' => esc_html__('Starter Package', 'roavio-toolkit'),
				'layout_five_package_description' => esc_html__('Small businesses and startups', 'roavio-toolkit'),
				'layout_five_price' => esc_html__('$5,000', 'roavio-toolkit'),
				'layout_five_duration' => esc_html__('/per month', 'roavio-toolkit'),
				'layout_five_is_popular' => 'no',
			],
			[
				'layout_five_package_title' => esc_html__('Enterprise Package', 'roavio-toolkit'),
				'layout_five_package_description' => esc_html__('Large businesses and requirements', 'roavio-toolkit'),
				'layout_five_price' => esc_html__('$30,000', 'roavio-toolkit'),
				'layout_five_duration' => esc_html__('/per month', 'roavio-toolkit'),
				'layout_five_is_popular' => 'yes',
			],
			[
				'layout_five_package_title' => esc_html__('Custom Package', 'roavio-toolkit'),
				'layout_five_package_description' => esc_html__('Businesses with unique, large-scale', 'roavio-toolkit'),
				'layout_five_price' => esc_html__('$75,000', 'roavio-toolkit'),
				'layout_five_duration' => esc_html__('/per month', 'roavio-toolkit'),
				'layout_five_is_popular' => 'no',
			],
		],
...
$yearly_repeater->add_control(
	...
	[
		...
		'default' => [
			[
				'layout_five_yearly_feature_text' => esc_html__('Custom software development', 'roavio-toolkit'),
			],
			[
				'layout_five_yearly_feature_text' => esc_html__('Requirement analysis & planning', 'roavio-toolkit'),
			],
			[
				'layout_five_yearly_feature_text' => esc_html__('Support and maintenance', 'roavio-toolkit'),
			],
			[
				'layout_five_yearly_feature_text' => esc_html__('Integration third-party services', 'roavio-toolkit'),
			],
			[
				'layout_five_yearly_feature_text' => esc_html__('Data backups and advanced', 'roavio-toolkit'),
			],
			[
				'layout_five_yearly_feature_text' => esc_html__('Analytics and reporting features', 'roavio-toolkit'),
			],
			[
				'layout_five_yearly_feature_text' => esc_html__('Priority support 24/7', 'roavio-toolkit'),
			],
		],
...
$this->add_control(
	...
	[
		...
		'default' => [
			[
				'layout_five_yearly_package_title' => esc_html__('Starter Package', 'roavio-toolkit'),
				'layout_five_yearly_package_description' => esc_html__('Small businesses and startups', 'roavio-toolkit'),
				'layout_five_yearly_price' => esc_html__('$50,000', 'roavio-toolkit'),
				'layout_five_yearly_duration' => esc_html__('/per year', 'roavio-toolkit'),
				'layout_five_yearly_is_popular' => 'no',
			],
			[
				'layout_five_yearly_package_title' => esc_html__('Enterprise Package', 'roavio-toolkit'),
				'layout_five_yearly_package_description' => esc_html__('Large businesses and requirements', 'roavio-toolkit'),
				'layout_five_yearly_price' => esc_html__('$700,00', 'roavio-toolkit'),
				'layout_five_yearly_duration' => esc_html__('/per year', 'roavio-toolkit'),
				'layout_five_yearly_is_popular' => 'yes',
			],
			[
				'layout_five_yearly_package_title' => esc_html__('Custom Package', 'roavio-toolkit'),
				'layout_five_yearly_package_description' => esc_html__('Businesses with unique, large-scale', 'roavio-toolkit'),
				'layout_five_yearly_price' => esc_html__('$950,00', 'roavio-toolkit'),
				'layout_five_yearly_duration' => esc_html__('/per year', 'roavio-toolkit'),
				'layout_five_yearly_is_popular' => 'no',
			],
		],
