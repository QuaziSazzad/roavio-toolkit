...
$this->add_control(
	...
	[
		...
		'default' => [
			[
				'feature_text' => esc_html__('Reliable Support &amp; Maintenance Services', 'roavio-toolkit'),
			],
			[
				'feature_text' => esc_html__('Data-Driven Insights for Smarter Decisions', 'roavio-toolkit'),
			],
			[
				'feature_text' => esc_html__('Tailored Software Development for Every Need', 'roavio-toolkit'),
			],
		],
