...
$this->add_control(
	...
	[
		...
		'default' => esc_html__('Get Started Us', 'roavio-toolkit'),
		'label_block' => true,
	]
);
...
$this->add_control(
	...
	[
		'label' => esc_html__('Logo Caption', 'roavio-toolkit'),
		'type' => \Elementor\Controls_Manager::TEXT,
		'default' => esc_html__('Next-Generation AI Tools for Smarter Business', 'roavio-toolkit'),
		'label_block' => true,
	]
);
