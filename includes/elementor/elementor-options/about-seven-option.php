...
$this->add_control(
	...
	[
		...
		'default' => esc_html__('Best talent, Competitive Cost, Incredible IT Service Infrastructure', 'roavio-toolkit'),
		'label_block' => true,
	]
);
...
$repeater->add_control(
	...
	[
		'label' => esc_html__('Title', 'roavio-toolkit'),
		'type' => \Elementor\Controls_Manager::TEXT,
		'default' => esc_html__('Awards Winning Company', 'roavio-toolkit'),
		'label_block' => true,
	]
);
...
$repeater->add_control(
	...
	[
		...
		'type' => \Elementor\Controls_Manager::TEXTAREA,
		'default' => esc_html__('Sed ut perspiciat unde omnis este natus error sit voluptatem accusantium doloremque', 'roavio-toolkit'),
		'label_block' => true,
	]
);
	...
	[
		...
		'default' => [
			[
				...
				'title' => esc_html__('Awards Winning Company', 'roavio-toolkit'),
				'description' => esc_html__('Sed ut perspiciat unde omnis este natus error sit voluptatem accusantium doloremque', 'roavio-toolkit'),
				'link_text' => esc_html__('Read More', 'roavio-toolkit'),
				'link' => [
					'url' => '#',
				],
			],
			[
				...
				'title' => esc_html__('Startup IT Solution & Business Dev', 'roavio-toolkit'),
				'description' => esc_html__('Sed ut perspiciat unde omnis este natus error sit voluptatem accusantium doloremque', 'roavio-toolkit'),
				'link_text' => esc_html__('Read More', 'roavio-toolkit'),
				'link' => [
					'url' => '#',
