...
class Recent_Post extends Widget_Base
{
	...
	protected function register_controls()
	{
		...
		roavio_elementor_style_options($this, 'Section Title', '{{WRAPPER}} .sec-title', ['layout_one', 'layout_two', 'layout_three', 'layout_five']);
		roavio_elementor_style_options($this, 'Section Sub Title', '{{WRAPPER}} .sec-sub-title', ['layout_one', 'layout_two', 'layout_three', 'layout_five']);
		...
		roavio_elementor_style_options($this, 'Category', '{{WRAPPER}} .news-content span,{{WRAPPER}} .news-wrapper-3 .news-white-bg span', ['layout_one', 'layout_three', 'layout_five']);


		roavio_elementor_style_options($this, 'Read More', '{{WRAPPER}} .link-btn', ['layout_one', 'layout_two', 'layout_three', 'layout_five']);
		...
		roavio_elementor_style_options($this, 'Month', '{{WRAPPER}} .news-wrapper-3 .news-image-items-3 .news-image .box h6, {{WRAPPER}} .news-image h6', ['layout_one', 'layout_two', 'layout_three', 'layout_five']);
