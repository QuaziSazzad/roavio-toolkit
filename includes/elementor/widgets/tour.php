...
class Tour extends Widget_Base
{
	...
	protected function register_controls()
	{
		...
		roavio_elementor_style_options($this, 'Tour Title', '{{WRAPPER}} .tour-place-content h3 a', ['layout_one', 'layout_two', 'layout_three', 'layout_four']);
		roavio_elementor_style_options($this, 'Tour Features', '{{WRAPPER}} .tour-list li', ['layout_one', 'layout_two', 'layout_three', 'layout_four']);
