...
class Breadcrumbs extends Widget_Base
{
	...
	{
		return 'roavio-breadcrumbs';
	}

	public function get_title()
	{
		return esc_html__('Breadcrumbs', 'roavio-toolkit');
	}

	public function get_icon()
	{
		return 'eicon-tab-menu webtend-logo';
	}
	...
	{
		return ['roavio', 'toolkit', 'webtend', 'breadcrumbs'];
	}
	...
	protected function register_controls()
	{
		...
		include rt_get_elementor_option('breadcrumbs-one-option.php');
	...
	protected function render()
	{
		...
		include rt_get_elementor_template('breadcrumbs-one.php');
	}
}
