...
class Service_details extends Widget_Base
{
	...
	{
		return 'roavio-service-details';
	}

	public function get_title()
	{
		return esc_html__('Service Details', 'roavio-toolkit');
	}
	...
	{
		return ['roavio', 'toolkit', 'webtend', 'section', 'Service Details'];
	}
	...
	protected function register_controls()
	{
		...
		roavio_elementor_style_options($this, 'Section Title', '{{WRAPPER}} .section-title h2,{{WRAPPER}} .section-title h3', ['layout_one', 'layout_two', 'layout_three']);
		roavio_elementor_style_options($this, 'Section Sub Title', '{{WRAPPER}} .section-title .sub-title', ['layout_one', 'layout_two']);
		roavio_elementor_style_options($this, 'Section Description Text', '{{WRAPPER}} .left-content p, {{WRAPPER}} .section-title p,{{WRAPPER}}  .solution-beyond-content p', ['layout_one', 'layout_two', 'layout_three']);

		roavio_elementor_style_options($this, 'Features Title', '{{WRAPPER}} .it-solution-item h5', ['layout_two']);
		roavio_elementor_style_options($this, 'Features Text', '{{WRAPPER}} .list-style-two li, {{WRAPPER}} .it-solution-item p,{{WRAPPER}} .list-style-two li', ['layout_one', 'layout_two', 'layout_three']);
