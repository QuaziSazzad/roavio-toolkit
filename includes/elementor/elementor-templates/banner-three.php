                ...
                <div class="col-lg-5">
                    <div class="hero-image-three">
                        <?php if (!empty($settings['layout_three_image_one']['url'])) : ?>
                            <div class="image one">
                                <img data-aos="fade-right" data-aos-duration="1500" data-aos-offset="50" src="<?php echo esc_url($settings['layout_three_image_one']['url']); ?>" alt="<?php echo esc_attr__('Hero', 'roavio-toolkit'); ?>">
                            </div>
                        <?php endif; ?>

                        <?php if (!empty($settings['layout_three_image_two']['url'])) : ?>
                            <div class="image two">
                                <img data-aos="fade-left" data-aos-duration="1500" data-aos-offset="50" src="<?php echo esc_url($settings['layout_three_image_two']['url']); ?>" alt="<?php echo esc_attr__('Hero', 'roavio-toolkit'); ?>">
                            </div>
                        <?php endif; ?>

                        <?php if (!empty($settings['layout_three_image_three']['url'])) : ?>
                            <div class="image three">
                                <img data-aos="zoom-in" data-aos-delay="200" data-aos-duration="1500" data-aos-offset="50" src="<?php echo esc_url($settings['layout_three_image_three']['url']); ?>" alt="<?php echo esc_attr__('Hero', 'roavio-toolkit'); ?>">
                            </div>
                        <?php endif; ?>

                        <?php if (!empty($settings['layout_three_image_four']['url'])) : ?>
                            <div class="image four">
                                <img data-aos="fade-down" data-aos-duration="1500" data-aos-offset="50" src="<?php echo esc_url($settings['layout_three_image_four']['url']); ?>" alt="<?php echo esc_attr__('Hero', 'roavio-toolkit'); ?>">
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
