        ...
        <div class="container custom-container-4">
            <div class="section-title text-center">
                <?php if ($settings['layout_three_title']) : ?>
                    <<?php echo esc_attr($settings['layout_three_title_tag']); ?> class="wow fadeInUp sec-title" data-wow-delay=".3s"><?php echo rt_kses_basic($settings['layout_three_title']); ?></<?php echo esc_attr($settings['layout_three_title_tag']); ?>>
                <?php endif; ?>
