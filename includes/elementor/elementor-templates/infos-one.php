        ...
        <div class="container">
            <div class="section-title text-center">
                <?php if ($settings['layout_one_title']) : ?>
                    <<?php echo esc_attr($settings['layout_one_title_tag']); ?> class="fadeInUp sec-title text-anim"><?php echo rt_kses_basic($settings['layout_one_title']); ?></<?php echo esc_attr($settings['layout_one_title_tag']); ?>>
                <?php endif; ?>
