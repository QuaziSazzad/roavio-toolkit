        ...
        foreach ($settings['layout_three_faq_list'] as $index =>  $item) : ?>
            <div class="accordion-item" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                <h6 class="accordion-header">
                    <button class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#roavio_three<?php echo esc_attr($index . $uid); ?>">
                        <?php echo esc_html($item['title']); ?>
                    </button>
                </h6>
                <div id="roavio_three<?php echo esc_attr($index . $uid); ?>" class="accordion-collapse collapse <?php echo esc_attr($index == 1 ? 'show' : ''); ?>" data-bs-parent="#faq-accordion-one-<?php echo esc_attr($uid); ?>">
