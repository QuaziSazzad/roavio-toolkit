            ...
            <?php if (!empty($settings['layout_three_section_title']) || !empty($settings['layout_three_section_subtitle'])) : ?>
                <div class="section-title text-center">
                    <?php if (!empty($settings['layout_three_section_title'])) : ?>
                        <<?php echo esc_attr($settings['layout_three_title_tag']); ?> class="wow fadeInUp" data-wow-delay=".3s"><?php echo esc_html($settings['layout_three_section_title']); ?></<?php echo esc_attr($settings['layout_three_title_tag']); ?>>
                    <?php endif; ?>
                    <?php if (!empty($settings['layout_three_section_subtitle'])) : ?>
                        <<?php echo esc_attr($settings['layout_three_sub_title_tag']); ?> class="wow fadeInUp" data-wow-delay=".5s"><?php echo esc_html($settings['layout_three_section_subtitle']); ?></<?php echo esc_attr($settings['layout_three_sub_title_tag']); ?>>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
