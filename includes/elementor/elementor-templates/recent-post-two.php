        ...
        <div class="container custom-container-2">
            ...
            <div class="row">
                ...
                <?php if ('elementor-field' == $settings['post_type']) : ?>
                    <?php
                    if (is_array($settings['layout_two_post_list'])) :
                        foreach ($settings['layout_two_post_list'] as $post) :
                    ...
                    ?>
                            ...
                            ?>
                                <div class="<?php echo esc_attr($post['column']); ?> col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                                    <div class="news-card-items-2">
                                        <div class="news-image">
