                ...
                <div class="col-lg-8">
                    <div class="hero-content">
                        <?php if (!empty($settings['layout_three_title'])) : ?>
                            <<?php echo esc_attr($settings['layout_three_title_tag']); ?> class="wow fadeInUp section-title" data-wow-delay=".3s">
                        ...
                        <?php if (!empty($settings['layout_three_description'])) : ?>
                            <p class="wow fadeInUp desc" data-wow-delay=".5s">
                ...
                <div class="col-xl-11">
                    <div class="from-box wow fadeInUp" data-wow-delay=".3s">
                        <?php if (!empty($settings['layout_three_form_title'])) : ?>
                            <h5 class="form-title"><?php echo rt_kses_basic($settings['layout_three_form_title']); ?></h5>
                        <?php endif; ?>
                        <form action="<?php echo esc_url(home_url('/')); ?>" method="GET">
                            <div class="box-item-2">
                                ...
                                <div class="form-clt">
                                    <div class="form">
                                        <select class="single-select w-100">
                                            <option><?php echo esc_html($settings['layout_three_location_label']); ?></option>
                                            <?php
                                ...
                                <div class="form-clt">
                                    <div class="form">
                                        <select class="single-select w-100">
                                            <option><?php echo esc_html($settings['layout_three_tour_label']); ?></option>
                                            <?php
