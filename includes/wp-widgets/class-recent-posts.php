...
class Roavio_Recent_Posts extends WP_Widget
{
	...
	public function __construct()
	{
		...
		parent::__construct('roavio_recent_posts_widget', __('Roavio Recent Posts', 'roavio-toolkit'), $widget_ops);
	}

	public function widget($args, $instance)
	{
		$title          = ! empty($instance['title']) ? $instance['title'] : __('Recent Posts', 'roavio-toolkit');
...
?>
		...
		<p>
			<label for="<?php echo $this->get_field_id('num_posts'); ?>"><?php _e('Number of Posts:', 'roavio-toolkit'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('trim_words'); ?>"><?php _e('Trim Title Words:', 'roavio-toolkit'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('show_date'); ?>"><?php _e('Show Date:', 'roavio-toolkit'); ?></label>
			<select id="<?php echo $this->get_field_id('show_date'); ?>" name="<?php echo $this->get_field_name('show_date'); ?>" class="widefat">
				<option value="yes" <?php selected($show_date, 'yes'); ?>><?php _e('Yes', 'roavio-toolkit'); ?></option>
				<option value="no" <?php selected($show_date, 'no'); ?>><?php _e('No', 'roavio-toolkit'); ?></option>
			</select>
		</p>
		<p>
			<label for="<?php echo $this->get_field_id('show_thumbnail'); ?>"><?php _e('Show Thumbnail:', 'roavio-toolkit'); ?></label>
			<select id="<?php echo $this->get_field_id('show_thumbnail'); ?>" name="<?php echo $this->get_field_name('show_thumbnail'); ?>" class="widefat">
				<option value="yes" <?php selected($show_thumbnail, 'yes'); ?>><?php _e('Yes', 'roavio-toolkit'); ?></option>
				<option value="no" <?php selected($show_thumbnail, 'no'); ?>><?php _e('No', 'roavio-toolkit'); ?></option>
			</select>
		</p>
<?php
	}
