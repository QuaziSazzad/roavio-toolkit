...
class Roavio_CTA extends WP_Widget
{
	...
	{
		$widget_ops = array(
			'classname'   => 'roavio-wp-cta widget-cta',
			'description' => __('A custom call-to-action widget with background image and button', 'roavio-toolkit')
		);

		parent::__construct('roavio_cta_widget', __('Roavio Call to Action', 'roavio-toolkit'), $widget_ops);
	...
	{
		$heading = ! empty($instance['heading']) ? $instance['heading'] : __('Need Professional IT Services?', 'roavio-toolkit');
		$button_text = ! empty($instance['button_text']) ? $instance['button_text'] : __('Get In Touch', 'roavio-toolkit');
...
?>
		<p>
			<label for="<?php echo $this->get_field_id('heading'); ?>"><?php _e('Heading:', 'roavio-toolkit'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('button_text'); ?>"><?php _e('Button Text:', 'roavio-toolkit'); ?></label>
			<input class="widefat" id="<?php echo $this->get_field_id('button_text'); ?>" name="<?php echo $this->get_field_name('button_text'); ?>" type="text" value="<?php echo esc_attr($button_text); ?>">
		</p>
		<p>
			<label for="<?php echo $this->get_field_id('button_url'); ?>"><?php _e('Button URL:', 'roavio-toolkit'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('background_image'); ?>"><?php _e('Background Image URL:', 'roavio-toolkit'); ?></label>
			...
			<input type="button" class="button upload-image-button" value="<?php _e('Upload Image', 'roavio-toolkit'); ?>" />
			<br><small><?php _e('Enter the full URL to your background image or click "Upload Image"', 'roavio-toolkit'); ?></small>
		</p>
				...
				function initImageUploader() {
					$('.upload-image-button').off('click').on('click', function(e) {
						...
						var custom_uploader = wp.media({
							title: '<?php _e('Select Background Image', 'roavio-toolkit'); ?>',
							button: {
								text: '<?php _e('Use this image', 'roavio-toolkit'); ?>'
							},
							multiple: false,
							library: {
								type: 'image'
