...
use RoavioToolkit\ElementorAddon\Templates\Portfolio;
...
<div class="<?php Helper::container() ?>">
	<div class="content-area">
		<div class="portfolio-archive-content">
			<?php if (have_posts()): ?>
				<div class="roavio-portfolio-items layout-grid <?php echo esc_attr($options['design']) ?>">
					<?php
				...
				<?php Roavio_Post_Helper::pagination(); ?>
			<?php else : ?>
