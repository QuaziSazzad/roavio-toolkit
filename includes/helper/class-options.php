		...
		CSF::createSection($this->options_prefix, [
			...
			'fields' => [
				...
				[
					'id'      => 'preloader_text',
					'type'    => 'text',
					'title'   => esc_html__('Preloader Text', 'roavio-toolkit'),
				...
				[
					'id'      => 'loading_text',
					'type'    => 'text',
					'title'   => esc_html__('Loading Text', 'roavio-toolkit'),
					'default' => esc_html__('Loading', 'roavio-toolkit'),
					'dependency'  => ['site_preloader', '==', 'enabled'],
				],
		...
		CSF::createSection($this->options_prefix, [
			...
			'fields' => [
				...
				[
					'id'         => 'page_title_typo',
					'type'       => 'typography',
					'title'      => esc_html__('Page Title Typography', 'roavio-toolkit'),
					'output'     => '.breadcrumb-wrapper .page-heading h1',
					'dependency' => ['site_page_title', '==', 'enabled'],
				],
				[
		...
		CSF::createSection($this->options_prefix, [
			...
			'fields' => [
				...
				[
					...
					'desc'     => esc_html__('Default: #151515', 'roavio-toolkit'),
				],
				[
					'id'       => 'text_color',
					'type'     => 'color',
					'title'    => esc_html__('Text', 'roavio-toolkit'),
					'default'  => '#696969',
					'subtitle' => esc_html__('A neutral grey, easy to read color, used by all text elements.', 'roavio-toolkit'),
					'desc'     => esc_html__('Default: #696969', 'roavio-toolkit'),
				],
				[
					'id'       => 'border_color',
					'type'     => 'color',
					'title'    => esc_html__('Border', 'roavio-toolkit'),
					'default'  => '#C9C9C9',
					'subtitle' => esc_html__('Border color used throughout the website.', 'roavio-toolkit'),
					'desc'     => esc_html__('Default: #C9C9C9', 'roavio-toolkit'),
				],
				[
					'id'       => 'bg_color',
					'type'     => 'color',
					'title'    => esc_html__('Background', 'roavio-toolkit'),
					'default'  => '#F7F7F7',
					'subtitle' => esc_html__('A common light color for all backgrounds in your website.', 'roavio-toolkit'),
					'desc'     => esc_html__('Default: #F7F7F7', 'roavio-toolkit'),
				],
				[
					'id'       => 'bg_2_color',
					'type'     => 'color',
					'title'    => esc_html__('Background 2', 'roavio-toolkit'),
					'default'  => '#EDF2DE',
					'subtitle' => esc_html__('Generally used as background color for light, alternating sections.', 'roavio-toolkit'),
					'desc'     => esc_html__('Default: #EDF2DE', 'roavio-toolkit'),
				],
				[
					'id'       => 'black_color',
					'type'     => 'color',
					'title'    => esc_html__('Black', 'roavio-toolkit'),
					'default'  => '#000',
					'subtitle' => esc_html__('Pure black color.', 'roavio-toolkit'),
					'desc'     => esc_html__('Default: #000', 'roavio-toolkit'),
				],
				[
					'id'       => 'white_color',
					'type'     => 'color',
					'title'    => esc_html__('White', 'roavio-toolkit'),
					'default'  => '#fff',
					'subtitle' => esc_html__('Pure white color.', 'roavio-toolkit'),
					'desc'     => esc_html__('Default: #fff', 'roavio-toolkit'),
				],
			],
		]);
	}
